...
function DataEntryPage() {
  ...
  const categories = [
    ...
    { id: 'production', name: 'Production', icon: productionIcon, color: '#10b981' }
  ];
  ...
  const handleAddLine = () => {
    ...
    switch (selectedCategory) {
      case 'energie':
        ...
        setEnergieData({ annee: '2025', mois: '', site: '', type: '', unite: '', valeur: '' });
        break;
      case 'eau':
        ...
        setEauData({ annee: '2025', mois: '', site: '', familleCulture: '', variete: '', volumeEau: '' });
        break;
      case 'dechets':
        ...
        setDechetsData({ annee: '2025', mois: '', site: '', categorie: '', unite: '', valeur: '' });
        break;
      case 'social':
        ...
        setSocialData({ annee: '2025', mois: '', site: '', action: '', budget: '', beneficiaires: '' });
        break;
      case 'production':
        ...
        setProductionData({ annee: '2025', mois: '', site: '', action: '', budget: '', beneficiaires: '' });
        break;
    }
              ...
              <div className="card-content">
                ...
                {selectedCategory === 'energie' && (
                  <div className="form-grid">
                    <div className="form-group">
                      <label>Année</label>
                      <select value={energieData.annee} onChange={(e) => setEnergieData({ ...energieData, annee: e.target.value })}>
                    ...
                    <div className="form-group">
                      <label>Mois *</label>
                      <select value={energieData.mois} onChange={(e) => setEnergieData({ ...energieData, mois: e.target.value })}>
                    ...
                    <div className="form-group">
                      <label>Site *</label>
                      <select value={energieData.site} onChange={(e) => setEnergieData({ ...energieData, site: e.target.value })}>
                        <option value="">Sélectionner</option>
                    ...
                    <div className="form-group">
                      <label>Type *</label>
                      <select value={energieData.type} onChange={(e) => setEnergieData({ ...energieData, type: e.target.value })}>
                        <option value="">Sélectionner</option>
                    ...
                    <div className="form-group">
                      <label>Unité</label>
                      <select value={energieData.unite} onChange={(e) => setEnergieData({ ...energieData, unite: e.target.value })}>
                        <option value="">Sélectionner</option>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setEnergieData({ ...energieData, valeur: e.target.value })}
                        placeholder="0"
                      />
                    </div>
                  </div>
                ...
                {selectedCategory === 'eau' && (
                  <div className="form-grid">
                    <div className="form-group">
                      <label>Année</label>
                      <select value={eauData.annee} onChange={(e) => setEauData({ ...eauData, annee: e.target.value })}>
                        <option value="2025">2025</option>
                        <option value="2024">2024</option>
                        <option value="2023">2023</option>
                      </select>
                    ...
                    <div className="form-group">
                      <label>Mois *</label>
                      <select value={eauData.mois} onChange={(e) => setEauData({ ...eauData, mois: e.target.value })}>
                        <option value="">Sélectionner</option>
                        {mois.map(m => <option key={m.value} value={m.value}>{m.label}</option>)}
                      </select>
                    </div>
                    ...
                    <div className="form-group">
                      <label>Site *</label>
                      <select value={eauData.site} onChange={(e) => setEauData({ ...eauData, site: e.target.value })}>
                        <option value="">Sélectionner</option>
                        {sites.map(s => <option key={s.value} value={s.value}>{s.label}</option>)}
                      </select>
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <select value={eauData.familleCulture} onChange={(e) => setEauData({ ...eauData, familleCulture: e.target.value })}>
                        <option value="">Sélectionner</option>
                ...
                {selectedCategory === 'dechets' && (
                  <div className="form-grid">
                    <div className="form-group">
                      <label>Année</label>
                      <select value={dechetsData.annee} onChange={(e) => setDechetsData({ ...dechetsData, annee: e.target.value })}>
                        <option value="2025">2025</option>
                        <option value="2024">2024</option>
                        <option value="2023">2023</option>
                      </select>
                    ...
                    <div className="form-group">
                      <label>Mois *</label>
                      <select value={dechetsData.mois} onChange={(e) => setDechetsData({ ...dechetsData, mois: e.target.value })}>
                        <option value="">Sélectionner</option>
                        {mois.map(m => <option key={m.value} value={m.value}>{m.label}</option>)}
                      </select>
                    </div>
                    ...
                    <div className="form-group">
                      <label>Site *</label>
                      <select value={dechetsData.site} onChange={(e) => setDechetsData({ ...dechetsData, site: e.target.value })}>
                        <option value="">Sélectionner</option>
                        {sites.map(s => <option key={s.value} value={s.value}>{s.label}</option>)}
                      </select>
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <select value={dechetsData.categorie} onChange={(e) => setDechetsData({ ...dechetsData, categorie: e.target.value })}>
                        <option value="">Sélectionner</option>
                    ...
                    <div className="form-group">
                      <label>Unité</label>
                      <select value={dechetsData.unite} onChange={(e) => setDechetsData({ ...dechetsData, unite: e.target.value })}>
                        <option value="">Sélectionner</option>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setDechetsData({ ...dechetsData, valeur: e.target.value })}
                        placeholder="0"
                      />
                    </div>
                  </div>
                ...
                {selectedCategory === 'social' && (
                  <div className="form-grid">
                    <div className="form-group">
                      <label>Année</label>
                      <select value={socialData.annee} onChange={(e) => setSocialData({ ...socialData, annee: e.target.value })}>
                        <option value="2025">2025</option>
                        <option value="2024">2024</option>
                        <option value="2023">2023</option>
                      </select>
                    ...
                    <div className="form-group">
                      <label>Mois *</label>
                      <select value={socialData.mois} onChange={(e) => setSocialData({ ...socialData, mois: e.target.value })}>
                        <option value="">Sélectionner</option>
                        {mois.map(m => <option key={m.value} value={m.value}>{m.label}</option>)}
                      </select>
                    </div>
                    ...
                    <div className="form-group">
                      <label>Site *</label>
                      <select value={socialData.site} onChange={(e) => setSocialData({ ...socialData, site: e.target.value })}>
                        <option value="">Sélectionner</option>
                        {sites.map(s => <option key={s.value} value={s.value}>{s.label}</option>)}
                      </select>
                    </div>
                    ...
                    <div className="form-group">
                      <label>Action *</label>
                      <select value={socialData.action} onChange={(e) => setSocialData({ ...socialData, action: e.target.value })}>
                        <option value="">Sélectionner</option>
                        <option value="Formation professionnelle">Formation professionnelle</option>
                        <option value="Campagne santé">Campagne santé</option>
                        <option value="Soutien éducatif">Soutien éducatif</option>
                        <option value="Infrastructure communautaire">Infrastructure communautaire</option>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setSocialData({ ...socialData, budget: e.target.value })}
                        placeholder="0"
                      />
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setSocialData({ ...socialData, beneficiaires: e.target.value })}
                        placeholder="0"
                      />
                    </div>
                  </div>
                ...
                {selectedCategory === 'production' && (
                  <div className="form-grid">
                    <div className="form-group">
                      <label>Année</label>
                      <select value={productionData.annee} onChange={(e) => setProductionData({ ...productionData, annee: e.target.value })}>
                        <option value="2025">2025</option>
                        <option value="2024">2024</option>
                        <option value="2023">2023</option>
                      </select>
                    ...
                    <div className="form-group">
                      <label>Mois *</label>
                      <select value={productionData.mois} onChange={(e) => setProductionData({ ...productionData, mois: e.target.value })}>
                        <option value="">Sélectionner</option>
                        {mois.map(m => <option key={m.value} value={m.value}>{m.label}</option>)}
                      </select>
                    </div>
                    ...
                    <div className="form-group">
                      <label>Site *</label>
                      <select value={productionData.site} onChange={(e) => setProductionData({ ...productionData, site: e.target.value })}>
                        <option value="">Sélectionner</option>
                        {sites.map(s => <option key={s.value} value={s.value}>{s.label}</option>)}
                      </select>
                    </div>
                    ...
                    <div className="form-group">
                      <label>Action *</label>
                      <select value={productionData.action} onChange={(e) => setProductionData({ ...productionData, action: e.target.value })}>
                        <option value="">Sélectionner</option>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setProductionData({ ...productionData, beneficiaires: e.target.value })}
                        placeholder="0"
                      />
                    </div>
                  </div>
              ...
              <div className="card-header">
                <div className="header-with-button">
                  <div>
                    ...
                    <p className="card-description">{entries.length} entrée(s) en attente de soumission</p>
                  </div>
                      ...
                      {entries.map((entry) => (
                        <tr key={entry.id}>
                          ...
                          <td className="details-cell">
                            {entry.category === 'Énergie' && `${entry.type} - ${entry.unite || 'N/A'} - ${entry.valeur || 'N/A'}`}
                            {entry.category === 'Eau' && `${entry.familleCulture || 'N/A'} - ${entry.variete || 'N/A'} - ${entry.volumeEau} m³`}
                            {entry.category === 'Déchets' && `${entry.categorie || 'N/A'} - ${entry.valeur} ${entry.unite || ''}`}
                            {entry.category === 'Social' && `${entry.action} - ${entry.budget || '0'} MAD - ${entry.beneficiaires || '0'} bénéf.`}
                            {entry.category === 'Production' && `${entry.action} - ${entry.budget || '0'} MAD - ${entry.beneficiaires || '0'} bénéf.`}
                          </td>
                          <td>
